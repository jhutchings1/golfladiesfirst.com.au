  ...
  return (
    <div className="flex-shrink-0">
      <span
        ...
        } relative flex-shrink-0 inline-block h-6 transition duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer w-11 focus:outline-none focus:shadow-outline-pink`}
      >
        <span
          aria-hidden="true"
          className={`${

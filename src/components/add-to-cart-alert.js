      ...
      item && (
        ...
        >
          <AnimatedDialogContent
            ...
            className="fixed right-0 w-full max-w-sm p-4 mt-4 mr-4 bg-white rounded shadow top-20 sm:mr-6 lg:mr-8 bg-white-50"
          >
            <div
              aria-hidden
            ...
            <div>
              ...
              <div className="flex mt-6">
                <div>
                  <img src={src} alt="" className="object-contain w-24 h-24" />
                </div>
                <div className="ml-4">
                  <h2 className="font-bold leading-tight uppercase">{title}</h2>
              ...
              <div className="flex items-center justify-between mt-6">
                <span className="inline-flex shadow-sm">
                  <Link
                    to="/cart/"
                    className="inline-block px-8 py-2 text-sm font-bold tracking-wider uppercase transition duration-150 ease-in-out border border-white hover:bg-primary hover:text-white focus:outline-none focus:shadow-outline-primary border-primary text-primary"
                  >
                    View cart
                  </Link>
                </span>
                <span className="inline-flex shadow-sm">
                  <a
                    href={checkout}
                    className="inline-block px-8 py-2 text-sm font-bold tracking-wider text-white uppercase transition duration-150 ease-in-out border border-primary bg-primary hover:bg-white hover:text-primary focus:outline-none focus:shadow-outline-primary"
                  >
                    Check out
                  </a>
                </span>
